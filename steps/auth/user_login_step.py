...
def user_login_step(login_page: LoginPage, username: str, password: str):
    ...
    """
    element_wait_then_fill(login_page, element=login_page._USERNAME_INPUT, text=username)
    element_wait_then_fill(login_page, element=login_page._PASSWORD_INPUT, text=password)
