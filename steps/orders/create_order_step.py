...
def create_order_step(driver, product_name: str, first_name: str, last_name: str, postal_code: str):
    ...
    item_price_at_inventory_page = inventory_page.get_price_by_product_name(product_name)
    logger.info(f"Price of item at the inventory page '{product_name}': {item_price_at_inventory_page}")
    ...
    expect_cart_has_item(driver, product_name=product_name, expected_price=item_price_at_inventory_page)
